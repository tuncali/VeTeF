...
class STaliroSignal(object):
    """STaliroSignal class defines signal properties received from STaliro. Control Point arrays of the signal etc.
    See STaliro documentation for better understanding."""
    SIGNAL_TYPE_SPEED = 0
    ...
    def __init__(self, signal_type, interpolation_type, ref_index, ref_field, signal_values, ref_values):
    ...
    def get_signal_value_corresponding_to_value_of_reference(self, reference_value, interpolation_type):
