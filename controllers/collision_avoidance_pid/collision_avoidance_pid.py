...
# **********************************************************************************************
class collision_avoidance_pid(BaseCarController):
    def __init__(self, car_model):
        BaseCarController.__init__(self, car_model[0])
        self.TARGET_SPEED = 40.0
        self.MIN_TARGET_SPEED = 10.0
        self.MAX_TARGET_SPEED = 70.0
        self.TARGET_FOLLOWING_DISTANCE = 20.0
        self.SIDE_FRONT_COLL_AVOIDANCE_TRIGGER_TTC = 2.0
        self.SIDE_READ_COLL_AVOIDANCE_TRIGGER_TTC = 2.0
        self.FRONT_COLL_AVOIDANCE_TRIGGER_TTC = 3.0
        ...
        self.MAX_NEGATIVE_THROTTLE_CHANGE = -float(STEP_TIME)/3000.0
        self.MAX_POSITIVE_THROTTLE_CHANGE = float(STEP_TIME)/1000.0 #I want to give full throttle from 0 in 1 sec.
        self.STANLEY_K = 0.25
        self.STANLEY_K2 = 0.3
        self.STANLEY_K3 = 1.0
        self.ref_long_distance = -10.0
        self.ref_lat_distance = 3.5
        self.ref_orientation = 0.0
        self.received_message = []
        self.TARGET_VHC_ID = 1
        self.SELF_VHC_ID = 2
